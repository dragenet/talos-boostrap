---
title: "ADR-007: Ansible as a portable, provider-agnostic cluster bootstrap layer"
description: Ansible bootstraps all providers using a single rule: provider-agnostic at the top, provider-specific under providers/<name>/.
type: adr
audience: [contributor, ai]
tags: [adr, ansible, bootstrap, provider]
status: accepted
created: 2026-07-01
updated: 2026-07-01
---
