---
title: "ADR-011: Config compiler — single input, deterministic render, one writer per file"
description: A config compiler renders cluster.yaml into Talos patches and Flux artifacts; each file has exactly one owner — template, render, or user.
type: adr
audience: [contributor, ai]
tags: [adr, config, render, architecture]
status: accepted
created: 2026-07-01
updated: 2026-07-01
---
