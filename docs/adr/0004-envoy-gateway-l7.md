---
title: "ADR-004: Envoy Gateway as the sole Gateway API implementation"
description: Envoy Gateway is the default Gateway API controller; Cilium L7 proxy is disabled, cleanly separating L3/L4 from L7 routing.
type: adr
audience: [contributor, ai]
tags: [adr, networking, gateway-api, envoy]
status: accepted
created: 2026-07-01
updated: 2026-07-01
---
