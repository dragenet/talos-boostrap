---
title: "ADR-009: OpenEBS LocalLV LVM for low-latency local storage"
description: OpenEBS LocalLV LVM provides a fast local-disk storage tier via LVM VG on a Talos RawVolumeConfig partition, alongside networked storage.
type: adr
audience: [contributor, ai]
tags: [adr, storage, openebs, talos]
status: accepted
created: 2026-07-01
updated: 2026-07-01
---
