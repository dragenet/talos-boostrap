---
title: "ADR-005: Cloud controller manager — tri-state enablement and provider resolution"
description: CCM uses a tri-state auto/true/false key; it is installed pre-Flux by Ansible and adopted by Flux, gated by provider support.
type: adr
audience: [contributor, ai]
tags: [adr, cloud, ccm, provider, bootstrap]
status: accepted
created: 2026-07-01
updated: 2026-07-01
---
